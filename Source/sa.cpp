...
{
    if (!CanSeeOutSideFromCurrAreaSA() && IsTimeForStarsies(ms_nGameClockHoursSA))
    {
        ...
        RwRenderStateSetSA(10, (void*)5); /* rwRENDERSTATESRCBLEND */
        RwRenderStateSetSA(11, (void*)6); /* rwRENDERSTATEDESTBLEND */
    }
